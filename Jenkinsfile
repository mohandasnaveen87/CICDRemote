	    ...
	    stages {
	        ...
	        stage('Deploy to UAT') {
	            steps {
					...
					credentials: ExternalApp(accountForApp: "sampleapp", applicationId: "603c4964-9d15-4ce3-8214-7da00d2004fa",applicationSecret: 'mysecret',applicationScope: "OR.Administration OR.Execution OR.Folders OR.Jobs OR.Machines OR.Queues OR.Robots OR.Settings OR.Tasks",identityUrl:""),
					traceLevel: 'None',
